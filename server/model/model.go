...
var (
	...
	SectionBogies = map[int]int{SectionA: 10, SectionB: 5}
	...
	Users = map[int]booking.User{
		...
		4: booking.User{FirstName: "Vijay", LastName: "v", Email: "sv@gmail.com", Id: 4},
	}
	...
	scheduledTrains = map[int]DaysForRunningTrain{
		1234: DaysForRunningTrain{
			Day:  map[weekday]struct{}{Mon: struct{}{}, Tue: struct{}{}},
			Time: "6PM",
		},
	}
